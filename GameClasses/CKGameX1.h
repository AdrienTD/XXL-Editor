...
struct CKHkTurtle : CKHookSubclass<CKHkTurtle, CKHkSquadEnemy, 88> {
	kobjref<CAnimationDictionary> ckhtUnk17;
	kobjref<CAnimationDictionary> ckhtUnk18;
	kobjref<CAnimationDictionary> ckhtUnk19;
	kobjref<CKSoundDictionaryID> ckhtUnk20;
	kobjref<CAnimatedClone> ckhtUnk21;
	kobjref<CAnimatedClone> ckhtUnk22;
	kobjref<CDynamicGround> ckhtUnk23;
	kobjref<CParticlesNodeFx> ckhtUnk24;
	kobjref<CParticlesNodeFx> ckhtUnk25;
	kobjref<CParticlesNodeFx> ckhtUnk26;
	std::array<float, 3> ckhtUnk27;
	std::array<float, 3> ckhtUnk28;
	std::array<float, 3> ckhtUnk29;
	std::array<float, 3> ckhtUnk30;
	std::array<float, 3> ckhtUnk31;
	std::array<float, 3> ckhtUnk32;
	std::array<float, 3> ckhtUnk33;
	std::array<float, 3> ckhtUnk34;
	std::array<float, 3> ckhtUnk35;
	uint16_t ckhtUnk36;
	uint16_t ckhtUnk37;
	EventNode ckhtUnk38;
	EventNode ckhtUnk39;
	kobjref<CKProjectileTypeScrap> ckhtUnk40;
	kobjref<CKProjectileTypeScrap> ckhtUnk41;
	void reflectMembers2(MemberListener& r, KEnvironment* kenv);
};
...
struct CKHkBoss : CKHookSubclass<CKHkBoss, CKHook, 177> {
	...
	std::array<BossPhase, 5> ckhbPhases;
	struct BossHuh {
		float ckhbUnk20;
		float ckhbUnk21;
		int32_t ckhbUnk22;
	...
	std::array<BossProjectile, 4> ckhbProjectiles;
	...
	std::array<BossRoller, 4> ckhbRollers;
	struct BossScrew {
	...
	std::array<BossScrew, 8> ckhbScrews;
