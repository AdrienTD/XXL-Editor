...
void CKHkAnimatedCharacter::reflectMembers2(MemberListener& r, KEnvironment* kenv)
{
	CKHook::reflectMembers2(r, kenv);
...
void CKHkTorch::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkHearth::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkDrawbridge::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkMegaAshtray::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkCorkscrew::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkTurnstile::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkLifter::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkLightPillar::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
}
void CKHkWind::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkPowderKeg::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkSwingDoor::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkHelmetCage::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkRollingStone::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkPushPullAsterix::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkClueMan::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkSky::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
}
void CKHkAsterixShop::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkWaterFall::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
	r.reflect(wfallBranch2, "wfallBranch2");
	r.reflect(wfallUnk1, "wfallUnk1");
	r.reflect(wfallUnk2, "wfallUnk2");
}
void CKHkAsterixCheckpoint::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkTeleBridge::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	CKHook::reflectMembers2(r, kenv);
...
void CKHkTowedTelepher::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
...
void CKHkInterfaceInGame::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
...
void CKHkParkourSteleAsterix::reflectMembers2(MemberListener& r, KEnvironment* kenv)
{
	CKHook::reflectMembers2(r, kenv);
...
void CKHkBoss::reflectMembers2(MemberListener& r, KEnvironment* kenv) {
	...
	r.reflect(ckhbUnk8, "ckhbUnk8");
	r.reflect(ckhbUnk9, "ckhbUnk9");
	r.foreachElement(ckhbPhases, "ckhbPhases", [&](BossPhase& phase) {
		r.reflect(phase.shakeAmount, "shakeAmount");
		r.reflect(phase.machineShakeAmount, "machineShakeAmount");
		r.reflect(phase.phaseUnk0, "phaseUnk0");
		r.reflect(phase.machineSoundSpeed, "machineSoundSpeed");
		r.reflect(phase.rollerSpinSpeed, "rollerSpinSpeed");
		r.reflect(phase.rollerExtendTime, "rollerExtendTime");
		r.reflect(phase.rollerDisplacement, "rollerDisplacement");
		r.reflect(phase.phaseUnk1, "phaseUnk1");
		r.reflect(phase.timeBeforeSmoke, "timeBeforeSmoke");
		r.reflect(phase.machineSpeed, "machineSpeed");
		r.reflect(phase.bombAltitude, "bombAltitude");
		r.reflect(phase.fireRate, "fireRate");
		r.reflect(phase.phaseUnk2, "phaseUnk2");
		r.reflect(phase.phaseUnk3, "phaseUnk3");
		r.reflect(phase.burstRate, "burstRate");
		r.reflect(phase.phaseUnk4, "phaseUnk4");
		r.reflect(phase.phaseUnk5, "phaseUnk5");
		r.reflect(phase.phaseUnk6, "phaseUnk6");
		r.reflect(phase.phaseUnk7, "phaseUnk7");
		r.reflect(phase.numBombs, "numBombs");
		});
	r.foreachElement(ckhbHuhs, "ckhbHuhs", [&](BossHuh& huh) {
		r.reflect(huh.ckhbUnk20, "ckhbUnk20");
		r.reflect(huh.ckhbUnk21, "ckhbUnk21");
		r.reflect(huh.ckhbUnk22, "ckhbUnk22");
		r.reflect(huh.ckhbUnk23, "ckhbUnk23");
		r.reflect(huh.ckhbUnk24, "ckhbUnk24");
		});
	r.reflect(ckhbUnk35, "ckhbUnk35");
	r.reflect(ckhbUnk36, "ckhbUnk36");
	r.foreachElement(ckhbProjectiles, "ckhbProjectiles", [&](BossProjectile& proj) {
		r.reflect(proj.ckhbUnk37, "ckhbUnk37");
		r.reflect(proj.ckhbUnk38, "ckhbUnk38");
		r.reflect(proj.ckhbUnk39, "ckhbUnk39");
		});
	r.reflect(ckhbUnk49, "ckhbUnk49");
	r.reflect(ckhbUnk50, "ckhbUnk50");
	r.reflect(ckhbUnk51, "ckhbUnk51");
	r.reflect(ckhbUnk52, "ckhbUnk52");
	r.reflect(ckhbUnk53, "ckhbUnk53");
	r.foreachElement(ckhbRollers, "ckhbRollers", [&](BossRoller& roller) {
		r.reflect(roller.ckhbUnk54, "ckhbUnk54");
		r.reflect(roller.ckhbUnk55, "ckhbUnk55");
		r.reflect(roller.ckhbUnk56, "ckhbUnk56");
		r.reflect(roller.ckhbUnk57, "ckhbUnk57");
		});
	r.foreachElement(ckhbScrews, "ckhbScrews", [&](BossScrew& screw) {
		r.reflect(screw.ckhbUnk70, "ckhbUnk70");
		r.reflect(screw.ckhbUnk71, "ckhbUnk71");
		r.reflect(screw.ckhbUnk72, "ckhbUnk72");
		r.reflect(screw.ckhbUnk73, "ckhbUnk73");
		r.reflect(screw.ckhbUnk74, "ckhbUnk74");
		});
